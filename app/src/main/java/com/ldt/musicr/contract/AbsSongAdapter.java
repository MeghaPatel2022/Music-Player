    ...
    public class SongHolder extends AbsMediaHolder<Song> {
        ...
        private void bindMediaPlayState() {
            if (MusicPlayerRemote.getCurrentSong().id == getData().get(getDataPosition(getAdapterPosition())).id) {
                ...
                mTitle.setTextColor(getContext().getResources().getColor(R.color.current_color));
                mDescription.setTextColor(getContext().getResources().getColor(R.color.current_color));
//                mQuickPlayPause.setColorFilter(getContext().getResources().getColor(R.color.current_color));

                if (MusicPlayerRemote.isPlaying()) {
                    mQuickPlayPause.setImageResource(R.drawable.ic_paus_now);
                } else {
                    mQuickPlayPause.setImageResource(R.drawable.ic_play_now);
                }
            } else {
