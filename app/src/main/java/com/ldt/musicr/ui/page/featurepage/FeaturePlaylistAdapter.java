...
public class FeaturePlaylistAdapter extends RecyclerView.Adapter<FeaturePlaylistAdapter.ItemHolder> {
    ...
    private final boolean showAuto;
    ...
    private static class PlaylistBitmapLoader extends AsyncTask<Void, Void, Bitmap> {
        private final FeaturePlaylistAdapter mAdapter;
        private final ItemHolder mItemHolder;
        ...
        protected void onPostExecute(Bitmap bitmap) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                mItemHolder.art.setClipToOutline(true);
            }
            Glide.with(mAdapter.mContext)
                    .load(bitmap)
                    .error(R.drawable.ic_music_default)
                    .placeholder(R.drawable.ic_music_default)
                    .into(mItemHolder.art);
//            mItemHolder.art.setImageBitmap(bitmap);
        ...
        protected Bitmap doInBackground(Void... v) {
            ...
            return BitmapFactory.decodeResource(mAdapter.mContext.getResources(), R.drawable.ic_default_image);
        }
    }
